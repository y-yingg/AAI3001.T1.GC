...
MODEL_PATH = "models/resnet18_pedestrian.pt"   # <- Base model here
...
# ---------- Page CSS (adds blue mini-title style to match page title vibe) ----------
st.markdown("""
<style>
.section-title-blue{
  color:#2d6cdf;
...
/* small tweak so the HR has a bit of breathing room */
...
def main():
    ...
    # >>>>>>> NEW: blue mini-heading above the Run Model button
    st.markdown('<div class="section-title-blue">View Examples (Base Resnet Model)</div>', unsafe_allow_html=True)
